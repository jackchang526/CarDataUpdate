...
namespace BitAuto.CarDataUpdate.DataProcesser.com.bitauto.carser {
    using System;
    ...
    public partial class Service : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback GetUVByTypeOperationCompleted;
        
        private bool useDefaultCredentialsSetExplicitly;
        
        /// <remarks/>
        public Service() {
            this.Url = global::BitAuto.CarDataUpdate.DataProcesser.Properties.Settings.Default.DataProcesser_com_bitauto_carser_Service;
        ...
        /// <remarks/>
        public event GetUVByTypeCompletedEventHandler GetUVByTypeCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("WebServiceForPicMasterToSerial/GetUVByType", RequestNamespace="WebServiceForPicMasterToSerial", ResponseNamespace="WebServiceForPicMasterToSerial", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public System.Xml.XmlElement[] GetUVByType(string type, int[] idList) {
            object[] results = this.Invoke("GetUVByType", new object[] {
                        type,
                        idList});
        ...
        /// <remarks/>
        public void GetUVByTypeAsync(string type, int[] idList) {
            this.GetUVByTypeAsync(type, idList, null);
        }
        
        /// <remarks/>
        public void GetUVByTypeAsync(string type, int[] idList, object userState) {
            if ((this.GetUVByTypeOperationCompleted == null)) {
                this.GetUVByTypeOperationCompleted = new System.Threading.SendOrPostCallback(this.OnGetUVByTypeOperationCompleted);
            }
            this.InvokeAsync("GetUVByType", new object[] {
                        type,
                        idList}, this.GetUVByTypeOperationCompleted, userState);
        }
        
        private void OnGetUVByTypeOperationCompleted(object arg) {
            if ((this.GetUVByTypeCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.GetUVByTypeCompleted(this, new GetUVByTypeCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.18408")]
    public delegate void GetUVByTypeCompletedEventHandler(object sender, GetUVByTypeCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.18408")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class GetUVByTypeCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal GetUVByTypeCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
